            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    ...
                    <div class="relative bg-white rounded-2xl shadow-2xl p-8">
                        <div class="space-y-6">
                            <!-- Course Card 1 -->
                            <div class="flex items-center space-x-4 bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-xl">
                                <div class="w-16 h-16 bg-blue-600 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            <!-- Course Card 2 -->
                            <div class="flex items-center space-x-4 bg-gradient-to-r from-purple-50 to-purple-100 p-4 rounded-xl">
                                <div class="w-16 h-16 bg-purple-600 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- Course Card 3 -->
                            <div class="flex items-center space-x-4 bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-xl">
                                <div class="w-16 h-16 bg-green-600 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
